      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            {/* Decorative block */}
            <div className="absolute -top-4 -left-4 w-16 h-16 rounded-2xl opacity-40" style={{ background: BRAND.orange }} />

            <div className="rounded-2xl overflow-hidden shadow-2xl" style={{ border: `3px solid rgba(247,148,29,0.2)` }}>
              <img
            ...
            >
              <div className="flex items-center gap-3">
                <div>
                  <div className="text-3xl font-bold" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>+34%</div>
