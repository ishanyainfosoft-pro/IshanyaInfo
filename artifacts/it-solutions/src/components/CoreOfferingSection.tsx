        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <ScrollReveal direction="right" delay={1} className="w-full" style={{ flex: "2" }}>
            ...
            <p className="mb-8 leading-relaxed text-base sm:text-lg" style={{ color: "#555555" }}>
              Our highly customized ERP solution offers a comprehensive suite of modules and advanced features to streamline operations, enhance efficiency, and provide actionable insights.
            </p>
